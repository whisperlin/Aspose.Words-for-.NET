...
namespace ApiExamples
{
    ...
    internal class ExHtmlSaveOptions : ApiExampleBase
    {
        ...
        public void ExportPageMargins(SaveFormat saveFormat)
        {
            ...
            Save(doc, ArtifactsDir +"HtmlSaveOptions.ExportPageMargins." + saveFormat.ToString().ToLower(), saveFormat, saveOptions);
        }
        ...
        public void ExportOfficeMath(SaveFormat saveFormat, HtmlOfficeMathOutputMode outputMode)
        {
            ...
            Save(doc, ArtifactsDir + "HtmlSaveOptions.ExportToHtmlUsingImage." + saveFormat.ToString().ToLower(), saveFormat, saveOptions);

            switch (saveFormat)
            {
                case SaveFormat.Html:
                    DocumentHelper.FindTextInFile(ArtifactsDir + "HtmlSaveOptions.ExportToHtmlUsingImage." + saveFormat.ToString().ToLower(), "<img src=\"HtmlSaveOptions.ExportToHtmlUsingImage.001.png\" width=\"49\" height=\"19\" alt=\"\" style=\"-aw-left-pos:0pt; -aw-rel-hpos:column; -aw-rel-vpos:paragraph; -aw-top-pos:0pt; -aw-wrap-type:inline\" />");
                    return;

                case SaveFormat.Mhtml:
                    DocumentHelper.FindTextInFile(ArtifactsDir + "HtmlSaveOptions.ExportToHtmlUsingImage." + saveFormat.ToString().ToLower(), "<math xmlns=\"http://www.w3.org/1998/Math/MathML\"><mi>A</mi><mo>=</mo><mi>π</mi><msup><mrow><mi>r</mi></mrow><mrow><mn>2</mn></mrow></msup></math>");
                    return;

                case SaveFormat.Epub:
                    DocumentHelper.FindTextInFile(ArtifactsDir + "HtmlSaveOptions.ExportToHtmlUsingImage." + saveFormat.ToString().ToLower(), "<span style=\"font-family:\'Cambria Math\'\">A=π</span><span style=\"font-family:\'Cambria Math\'\">r</span><span style=\"font-family:\'Cambria Math\'\">2</span>");
                    return;
            }
        }
        ...
        public void ExportTextBoxAsSvg(SaveFormat saveFormat, bool textBoxAsSvg)
        {
            ...
            Save(doc, ArtifactsDir + "HtmlSaveOptions.ExportTextBoxAsSvg." + saveFormat.ToString().ToLower(), saveFormat, saveOptions);
            ...
            switch (saveFormat)
            {
                ...
                case SaveFormat.Mhtml:
                    ...
                    DocumentHelper.FindTextInFile(ArtifactsDir + "HtmlSaveOptions.ExportTextBoxAsSvg." + saveFormat.ToString().ToLower(), "<img src=\"HtmlSaveOptions.ExportTextBoxAsSvg.001.png\" width=\"240\" height=\"119\" alt=\"\" style=\"margin:3.22pt 9pt 3.6pt 8.62pt; -aw-left-pos:0pt; -aw-rel-hpos:column; -aw-rel-vpos:paragraph; -aw-top-pos:14.4pt; -aw-wrap-type:square; float:left\" />");
                    return;
            }
        }
